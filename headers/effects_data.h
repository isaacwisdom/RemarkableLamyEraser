...
static const char* EFFECTS[NUM_EFFECTS] = {
  ...
  "one-off-eraser",           //ONE_OFF_ERASER           17
  "one-off-hl",               //ONE_OFF_HL               18
};
...
static const int LOCATION_LOOKUP_TOUCH[2][NUM_EFFECTS][4][2] = {
  {//NOTEBOOK
   // RHP                RHL                LHP                LHL
    ...
    {}, // ONE_OFF_ERASER_SELECTION (same as ERASER_SELECTION) 16
    {}, // ONE_OFF_ERASER           (same as ERASER)           17
    {}, // ONE_OFF_HL (same as WRITING_HL)                     18
  },
  {//PDF
   // RHP                RHL                LHP                LHL
    { {        0,    0}, {   0,         0}, {        0,    0}, {   0,         0} }, //NULL_EFFECT          0
