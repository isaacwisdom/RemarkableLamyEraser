...
wget https://github.com/isaacwisdom/RemarkableLamyEraser/raw/v2/config/LamyEraser.conf
...
if [[ $REPLY =~ ^[Yy]$ ]]
 then
  ...
  wget https://github.com/isaacwisdom/RemarkableLamyEraser/raw/v2/config/LamyEraser.service
