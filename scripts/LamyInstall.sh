...
wget https://github.com/slotThe/RemarkableLamyEraser/raw/v2-3.0.0-fix/RemarkableLamyEraser
...
wget https://github.com/slotThe/RemarkableLamyEraser/raw/v2-3.0.0-fix/config/LamyEraser.conf
...
if [[ $REPLY =~ ^[Yy]$ ]]
 then
  ...
  wget https://github.com/slotThe/RemarkableLamyEraser/raw/v2-3.0.0-fix/config/LamyEraser.service
